...
class SummaryOfReceivedReviewsViewState
  ...
  Widget build(BuildContext context) {
    ...
    return summaryOfReceivedReviews.when(
      data: (summaryOfReceivedReviews) => SingleChildScrollView(
        child: Container(
          height: height,
          width: width,
          child: GridView.count(
            ...
            children: <Widget>[
              ...
              for (int idx = 0; idx < summaryOfReceivedReviews.reviews!.length; idx++)
                Container(
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          summaryOfReceivedReviews.reviews![idx].email == null ? SizedBox(height: 0) : Expanded(
                              flex: 1, 
                              child: Container(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(
                                          summaryOfReceivedReviews.reviews![idx].email!,
                                          style: TextStyle(
                                            fontSize: 12,
                                            color: Colors.black
                                          ),
                          ...
                          summaryOfReceivedReviews.reviews![idx].name == null ? SizedBox(height: 0) : Expanded(
                            flex: 1, 
                            child: Container(
                              padding: EdgeInsets.all(3),
                              color: Colors.white,
                          ...
                          summaryOfReceivedReviews.reviews![idx].score == null ? SizedBox(height: 0) : Expanded(
                            flex: 1, 
                            child: Container(
                              padding: EdgeInsets.all(3),
                              color: Colors.white,
                  ...
                  onTap: () {
                    GoRouter.of(context).push('/review_detail/${summaryOfReceivedReviews.reviews![idx].reviewId}');
                  },
                ),
              ),
              ],
