                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      alignment: Alignment.centerLeft,
                      padding: EdgeInsets.all(15),
                      child: Text("${submissionDeadlineDateTime.hour.toString().padLeft(2, '0')}:${submissionDeadlineDateTime.minute.toString().padLeft(2, '0')}:${submissionDeadlineDateTime.second.toString().padLeft(2, '0')}  "
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      alignment: Alignment.centerLeft,
                      padding: EdgeInsets.all(15),
                      child: Text("${reviewDeadlineDateTime.hour.toString().padLeft(2, '0')}:${reviewDeadlineDateTime.minute.toString().padLeft(2, '0')}:${reviewDeadlineDateTime.second.toString().padLeft(2, '0')}  "
