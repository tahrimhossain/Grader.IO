...
class SummaryOfAssignedReviewsViewState
  ...
  late AsyncValue<SummaryOfAssignedSubmissionsForReview>
  ...
  Widget build(BuildContext context) {
    ...
    return summaryOfAssignedSubmissionsForReview.when(
      data: (summaryOfAssignedSubmissionsForReview) =>
          summaryOfAssignedSubmissionsForReview.submissions!.isEmpty
              ? Center(
                  child: Text('No reviews assigned'),
                )
                              ...
                              child: InkWell(
                                                    ...
                                                    Expanded(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            child: Text(
                                                              DateFormat(
                                                                      'HH:mm dd-MM-yyyy')
                                                                  .format(summaryOfAssignedSubmissionsForReview
                                                                      .submissions![
                                                                          idx]
                                                                      .submissionTime!),
                                                              style: TextStyle(
                                ...
                                onTap: () {
                                  GoRouter.of(context).push(
                                      '/submission_info/${summaryOfAssignedSubmissionsForReview.submissions![idx].submissionId}');
                                },
                              ),
                            ),
                        ],
