...
class SummaryOfSubmissionsViewState
  ...
  Widget build(BuildContext context) {
    ...
    return summaryOfSubmissions.when(
      data: (summaryOfSubmissions) => summaryOfSubmissions.submissions!.isEmpty
          ? Center(
          ...
          : SingleChildScrollView(
              child: Container(
                  ...
                  child: GridView.count(
                    ...
                    children: <Widget>[
                      for (int idx = 0;
                          idx < summaryOfSubmissions.submissions!.length;
                          idx++)
                        Container(
                            ...
                            child: Card(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  summaryOfSubmissions.submissions![idx]
                                              .submissionTime ==
                                          null
                                      ? SizedBox(height: 0)
                                      : Expanded(
